...
public class JhsmarttleApp {

    private static final Logger log = LoggerFactory.getLogger(JhsmarttleApp.class);

    private final Environment env;

    public JhsmarttleApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhsmarttle.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhsmarttleApp.class);
